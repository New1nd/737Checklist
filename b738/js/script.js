    ...
    const checklistData = [
        {
            title: "PRE FLIGHT",
            items: [
                {id: 1, label: "GEAR PINS & COVERS...REMOVED, ABOARD", subtitle: "CHECK", typeItem: "standard"},
                {id: 2, label: "OXYGEN", subtitle: "TESTED, 100%", typeItem: "standard"},
                {id: 3, label: "YAW DUMPER", subtitle: "ON", typeItem: "standard"},
                {id: 4, label: "NAV, TRANS & DISPLAY SWITCHES", subtitle: "NORMAL, AUTO", typeItem: "standard"},
                {id: 5, label: "EMERGENCY EXIT LIGHT", subtitle: "ARMED", typeItem: "standard"},
                {id: 6, label: "WINDOW HEAT", subtitle: "ON", typeItem: "standard"},
                {id: 7, label: "HYDRAULIC PANEL", subtitle: "PUMPS ON, NORMAL", typeItem: "standard"},
                {id: 8, label: "PRESSURIZATION MODE SELECTOR", subtitle: "AUTO", typeItem: "standard"},
                {id: 9, label: "FLIGHT INSTRUMENT", subtitle: "HEADING___ ALTIMETER", typeItem: "standard"},
                {id: 10, label: "SPEED BRAKE", subtitle: "DOWN DETENT", typeItem: "standard"},
                {id: 11, label: "PARKING BRAKE", subtitle: "SET, NORMAL", typeItem: "standard"},
                {id: 12, label: "ENGINE START LEVERS", subtitle: "CUTOFF", typeItem: "standard"},
                {id: 13, label: "PAPERS", subtitle: "ABOARD", typeItem: "standard"},
                {id: 14, label: "N1 & IAS", subtitle: "CHECKED", typeItem: "standard"},
        ...
        },
        {
            ...
            items: [
                ...
                {id: 15, label: "DOORS", subtitle: "CLOSED", typeItem: "standard"},
                {id: 16, label: "FLIGHT DECK DOORS", subtitle: "CLOSED AND LOCKED", typeItem: "standard"},
                {id: 17, label: "WINDOWS", subtitle: "LOCKED", typeItem: "standard"},
                {id: 18, label: "FUEL", subtitle: "__KG/PUMPS ON", typeItem: "standard"},
                {id: 19, label: "PASSENGER SIGNS", subtitle: "ON", typeItem: "standard"},
                {id: 20, label: "AIR CONDITIONING PACKS", subtitle: "OFF", typeItem: "standard"},
                {id: 21, label: "ISOLATION VALVE", subtitle: "OPEN", typeItem: "standard"},
                {id: 22, label: "MCP", subtitle: "V2__, HEADING__, ALTITUD__", typeItem: "standard"},
                {id: 23, label: "TAKEOFF SPEED", subtitle: "V1__, VR__, V2__", typeItem: "standard"},
                {id: 24, label: "CDU PREFLIGHT", subtitle: "COMPLETED", typeItem: "standard"},
                {id: 25, label: "RUDDER & AILERON TRIM", subtitle: "FREE & ZERO", typeItem: "standard"},
                {id: 25, label: "RUDDER & AILERON TRIM", subtitle: "FREE & ZERO", typeItem: "standard"},
                {id: 26, label: "ANTI-COLLISION LIGHT", subtitle: "ON", typeItem: "standard"},
        ...
        // },
        {
            title: "BEFORE TAXI",
            items: [
                {id: 27, label: "GENERATORS", subtitle: "ON", typeItem: "standard"},
                {id: 28, label: "PROBE HEAT", subtitle: "ON", typeItem: "standard"},
                {id: 29, label: "ANTI-ICE", subtitle: "AS REQUIRED", typeItem: "standard"},
                {id: 30, label: "AIR COND PACKS", subtitle: "AUTO", typeItem: "standard"},
                {id: 31, label: "ISOLATION VALVE", subtitle: "AUTO", typeItem: "standard"},
                {id: 32, label: "ENGINE START SWITCHES", subtitle: "CONT", typeItem: "standard"},
                {id: 33, label: "AUTO BRAKES", subtitle: "RTO", typeItem: "standard"},
                {id: 34, label: "FLIGHT CONTROLS", subtitle: "CHECKED", typeItem: "standard"},
                {id: 35, label: "ENGINE START LEVERS", subtitle: "IDLE DETENT", typeItem: "standard"},
                {id: 36, label: "GROUND EQUIPMENT", subtitle: "CLEAR", typeItem: "standard"},
                {id: 37, label: "RECALL", subtitle: "CHECKED", typeItem: "standard"},
        ...
        },
        {
            ...
            items: [
                {id: 38, label: "CABIN NOTIFICATION", subtitle: "COMPLETED", typeItem: "standard"},
                {id: 39, label: "MCP", subtitle: "CHECKED", typeItem: "standard"},
                {id: 40, label: "TRANSPONDER", subtitle: "ON, SET, TA/RA", typeItem: "standard"},
                {id: 41, label: "STAB TRIM", subtitle: "___UNITS", typeItem: "standard"},
                {id: 42, label: "FLAPS", subtitle: "___, GREEN LIGHT, DETENT", typeItem: "standard"},
                {id: 43, label: "RECALL", subtitle: "CHECK", typeItem: "standard"},
        ...
        },
        {
            ...
            items: [
                {id: 44, label: "ENGINE BLEEDS", subtitle: "ON", typeItem: "standard"},
                {id: 45, label: "PACKS", subtitle: "AUTO", typeItem: "standard"},
                {id: 46, label: "LANDING LIGHTS", subtitle: "OFF", typeItem: "standard"},
                {id: 47, label: "LANDING GEAR", subtitle: "UP & OFF", typeItem: "standard"},
                {id: 48, label: "FLAPS", subtitle: "UP, NO LIGHTS", typeItem: "standard"},
                {id: 49, label: "ALTIMETERS", subtitle: "STD SET, X-CHECKED", typeItem: "standard"},
